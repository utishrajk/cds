...
angular.module("bham.documentLibraryModule", ['treeControl', 'bham.security'])

    .config(['$routeProvider', 'USER_ROLES', function($routeProvider, USER_ROLES) {
            $routeProvider
            .when('/documentlibrary', {
    ...
    .controller("DocumentLibraryCtrl", ['$scope', '$window', function($scope, $window){
        //Select menu
