...
import com.feisystems.bham.service.reference.ASIRouteCodeService;
import com.feisystems.bham.util.Constant;

@Controller
@RequestMapping("/asiroutecodes")
public class ASIRouteCodeController {
	@Autowired
	ASIRouteCodeService asiRouteCodeService;
	...
	public List<LookupDto> listJson() {
		...
		List<LookupDto> result = asiRouteCodeService.findAllASIRouteCodes();
		return result;
	}
}
