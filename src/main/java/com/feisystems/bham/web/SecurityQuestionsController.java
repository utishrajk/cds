...
import com.feisystems.bham.service.reference.SecurityQuestionsService;
...
public class SecurityQuestionsController {
	@Autowired
    SecurityQuestionsService service;
    ...
    public List<LookupDto> listJson() {
        ...
        List<LookupDto> result = service.findAllSecurityQuestions();
        return result;
    }
}
