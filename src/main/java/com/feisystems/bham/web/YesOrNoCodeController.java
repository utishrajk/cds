...
import com.feisystems.bham.service.reference.YesOrNoCodeService;
import com.feisystems.bham.util.Constant;

@Controller
@RequestMapping("/yesornocodes")
public class YesOrNoCodeController {
	@Autowired
	YesOrNoCodeService yesOrNoCodeServce;
    ...
    public List<LookupDto> listJson() {
        ...
        List<LookupDto> result = yesOrNoCodeServce.findAllYesOrNoCodes();
        return result;
    }
}
