...
//import com.feisystems.bham.domain.reference.ProviderTaxonomyCodeDataOnDemand;
...
//	@Autowired
//    ProviderTaxonomyCodeDataOnDemand providerTaxonomyCodeDataOnDemand;
	...
	public OrganizationalProvider getNewTransientOrganizationalProvider(int index) {
        ...
        setProviderEntityType(obj, index);
	...
	public void setProviderEntityType(OrganizationalProvider obj, int index) {
        ProviderEntityType providerEntityType = ProviderEntityType.class.getEnumConstants()[0];
        obj.setProviderEntityType(providerEntityType);
    }
...
//        Long id = obj.getId();
	...
	public void init() {
        ...
        data =  organizationalProviderRepository.findAll(new PageRequest(from, to)).getContent();
        ...
        for (int i = 0; i < 10; i++) {
            ...
            try {
            	organizationalProviderRepository.save(obj);
